...
def plot_combined(
    ...
    out_dir: str = "exp_outputs/summary_backup/visualization_plots/folds",
) -> Path:
    apply_miccai_style()
...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="exp_outputs/summary_backup/summary/comprehensive_results.parquet",
        help="Input parquet file",
    )
    parser.add_argument(
        "--outdir",
        default="exp_outputs/summary_backup/visualization_plots/folds",
