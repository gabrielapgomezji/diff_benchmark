...
% \end{itemize}
Diffusion magnetic resonance imaging (dMRI) enables the in vivo representation of tissue 
...
While many report promising predictive \replace{performance}{power}, reported performance varies widely across 
...
design. As the number of dMRI–based prediction studies grows, the absence of a standardized and reproducible evaluation framework has become a critical 
bottleneck.
Without controlled evaluation across datasets, preprocessing pipelines, and model families, it is difficult to assess methodological progress and 
...
To address \replace{these limitations}{this problem}, we introduce an open-source diffusion MRI benchmark that 
...
representation and tissue-specific effects, and evaluates the \replace{incremental}{} value of diffusion-derived 
features beyond non-diffusion baselines. \replace{It provides the}{We believe this provides the} 
