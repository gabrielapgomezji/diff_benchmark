...
While many report promising predictive power, reported performance varies widely across 
...
To address this problem, we introduce an open-source diffusion MRI benchmark that 
...
representation and tissue-specific effects, and evaluates the value of diffusion-derived 
features beyond non-diffusion baselines. We believe this provides the
