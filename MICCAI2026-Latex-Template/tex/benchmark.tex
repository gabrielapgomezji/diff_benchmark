...
% Except for the HCP dataset, which is already preprocessed,
...
% ANTs \cite{Avants2009}, FreeSurfer \cite{Dale1999a} and AFNI \cite{Cox1996}.
% %
...
% %
% The anatomical T1w image was preprocessed using sMRIPrep.
...
Specifically, linear models (e.g., logistic regression, Lasso), Random Forests, and Support Vector Machines 
...
frozen feature extractors with prediction heads trained on top. In contrast, the 3D convolutional architecture MedicalNet \cite{chen2019med3d} is 
